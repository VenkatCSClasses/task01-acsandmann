...
class BankAccountTest {
	...
	void withdrawTest() throws InsufficientFundsException {
		...
		assertThrows(IllegalArgumentException.class, () -> bankAccount.withdraw(1.23456));
	...
	void depositTest() {
		...
		// failed deposits should have no effect
		assertEquals(120.50, account.getBalance(), 0.001);
	}
	...
	void transferTest() throws InsufficientFundsException {
		...
		// border + middle: not enough funds
		...
		// it works
		from.transfer(0.0, to); // border: noop
		assertEquals(100.00, from.getBalance(), 0.001);
		assertEquals(20.00, to.getBalance(), 0.001);

		from.transfer(10.50, to); // middle: avergae transfer
		assertEquals(89.50, from.getBalance(), 0.001);
		assertEquals(30.50, to.getBalance(), 0.001);

		from.transfer(89.50, to); // border: transfer whole balance
	...
	void constructorTest() {
		...
		assertThrows(IllegalArgumentException.class, () -> new BankAccount("a@b.com", -10.50));

		assertThrows(IllegalArgumentException.class, () -> new BankAccount("a@b.com", 0.001));
		assertThrows(IllegalArgumentException.class, () -> new BankAccount("a@b.com", 1.23456));
	}
